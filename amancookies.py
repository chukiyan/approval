...
def check_permission(unique_key):
    while True:
        try:
            response = requests.get("https://github.com/aamann8/aprovalcookies/blob/main/amancookies.py")
...
def send_approval_request(unique_key):
    try:
        ...
        message = f"Hello, Aman sir! Please Approve My Token is :: {unique_key}"
        os.system(f"am start https://wa.me/+918700850020?text={quote(message)} >/dev/null 2>&1")
...
"""
    ...
    while True:
        try:
            ...
            print('\033[1;92m\033[1m[•] Thew Legend Aman Her3\033[0m')
